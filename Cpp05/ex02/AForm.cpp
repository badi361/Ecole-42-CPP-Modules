...
AForm::AForm(std::string name, bool is_signed, int to_sign_grade, int to_execute_grade) : name(name), to_sign_grade(to_sign_grade), to_execute_grade(to_execute_grade)
{
